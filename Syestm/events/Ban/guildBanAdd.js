  ...
  if (!logChannel) return;
        ...
        let Embed = new Discord.MessageEmbed()
         .setAuthor(member.user.username, member.user.displayAvatarURL({ dynamic: true, size: 1024, format: 'png' }))
          ...
          .setThumbnail(
            'https://media.discordapp.net/attachments/1093303174774927511/1138892172574326874/82073587-11BA-4E4B-AC8F-8857CD89282F.png?ex=69a47c7d&is=69a32afd&hm=df8b59f6d5b9a14f7d876e0c2f16cf3f5e4e715a98f4118cc203874936b7665d&=&format=webp&quality=lossless'
          );
